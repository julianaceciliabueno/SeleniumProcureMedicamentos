...
class Test_medicamentos():
    def setup_method(self):
        self.driver = webdriver.Firefox(
            executable_path=''
                            'C:\\Users\\Juliana.bueno\\Desktop\\EncontreMeicamentos\\drivers\\geckodriver.exe')
    ...
    def test_pessoal(self):
        ...
        self.driver.find_element(By.NAME, "email").send_keys("testediariofox1311077@uorak.com")
        ...
        # iniciando
        self.driver.find_element(By.XPATH, "(//a[@href='/cluder/Saude'])[1]")
        self.driver.find_element(By.XPATH, "(//a[@href='/cluder/Saude'])[1]").click()
        self.driver.find_element(By.XPATH,
                                 "//div[@class='panel-body'][contains(.,'Medicamentos e farmácias')]").click()
        ...
        WebDriverWait(self.driver, 20).until(
            EC.element_to_be_clickable((By.XPATH,"//div[@class='clude-tab ajuste_tab'][contains(.,'Medicamentos')]"))).click()
